...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.partyGroupBd.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.party-group-bds.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('group_name_local') ? 'is-invalid' : '' }}" type="text" name="group_name_local" id="group_name_local" value="{{ old('group_name_local', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_site_name') ? 'is-invalid' : '' }}" type="text" name="office_site_name" id="office_site_name" value="{{ old('office_site_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('annual_revenue') ? 'is-invalid' : '' }}" type="number" name="annual_revenue" id="annual_revenue" value="{{ old('annual_revenue', '00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_employees') ? 'is-invalid' : '' }}" type="number" name="num_employees" id="num_employees" value="{{ old('num_employees', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ticker_symbol') ? 'is-invalid' : '' }}" type="text" name="ticker_symbol" id="ticker_symbol" value="{{ old('ticker_symbol', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('last_updated_stamp') ? 'is-invalid' : '' }}" name="last_updated_stamp_id" id="last_updated_stamp_id">
                    @foreach($last_updated_stamps as $id => $entry)
                        <option value="{{ $id }}" {{ old('last_updated_stamp_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_updated_tx_stamp') ? 'is-invalid' : '' }}" type="text" name="last_updated_tx_stamp" id="last_updated_tx_stamp" value="{{ old('last_updated_tx_stamp', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employee_position_type_in_local') ? 'is-invalid' : '' }}" type="text" name="employee_position_type_in_local" id="employee_position_type_in_local" value="{{ old('employee_position_type_in_local', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('group_brand_name') ? 'is-invalid' : '' }}" type="text" name="group_brand_name" id="group_brand_name" value="{{ old('group_brand_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tin_no') ? 'is-invalid' : '' }}" type="text" name="tin_no" id="tin_no" value="{{ old('tin_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vat_reg_no') ? 'is-invalid' : '' }}" type="text" name="vat_reg_no" id="vat_reg_no" value="{{ old('vat_reg_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('registratn_category') ? 'is-invalid' : '' }}" type="text" name="registratn_category" id="registratn_category" value="{{ old('registratn_category', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bin_no') ? 'is-invalid' : '' }}" type="text" name="bin_no" id="bin_no" value="{{ old('bin_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('acct_status') ? 'is-invalid' : '' }}" type="text" name="acct_status" id="acct_status" value="{{ old('acct_status', '') }}">
