...
@can('organization_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.party-bills.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.party_bills.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.party_bills.title_singular') }} {{ trans('global.list') }}
    </div>
...
<script>
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.party-bills.index') }}",
    columns: [
        ...
        { data: 'bill_ref_no', name: 'bill_ref_no' },
