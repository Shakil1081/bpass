...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.nonPurchaseOrder.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.non-purchase-orders.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-4">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('vat_tax') ? 'is-invalid' : '' }}" type="text" name="vat_tax" id="vat_tax" value="{{ old('vat_tax', '') }}">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('credit_limit') ? 'is-invalid' : '' }}" type="number" name="credit_limit" id="credit_limit" value="{{ old('credit_limit', '') }}" step="0.01">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('supplier') ? 'is-invalid' : '' }}" type="number" name="supplier" id="supplier" value="{{ old('supplier', '') }}" step="1">
                ...
                <div class="col=12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('supplier_address') ? 'is-invalid' : '' }}" name="supplier_address" id="supplier_address">{{ old('supplier_address') }}</textarea>
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('entry_date') ? 'is-invalid' : '' }}" type="text" name="entry_date" id="entry_date" value="{{ old('entry_date') }}">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('non_purchase_order_no') ? 'is-invalid' : '' }}" type="text" name="non_purchase_order_no" id="non_purchase_order_no" value="{{ old('non_purchase_order_no', '') }}">
