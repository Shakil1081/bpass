...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.barcodes.title_singular') }}
    </div>
...
{{--                            @endforeach--}}
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('cheque_amount') ? 'is-invalid' : '' }}" type="text" name="bar_code" id="bar_code" value="{{ old('bar_code', '') }}" required>
