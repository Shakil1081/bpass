    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.budgets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('budget_amount') ? 'is-invalid' : '' }}" type="number" name="budget_amount" id="budget_amount" value="{{ old('budget_amount', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('budget_date') ? 'is-invalid' : '' }}" type="text" name="budget_date" id="budget_date" value="{{ old('budget_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('budget_for') ? 'is-invalid' : '' }}" type="text" name="budget_for" id="budget_for" value="{{ old('budget_for', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('budget_name') ? 'is-invalid' : '' }}" type="text" name="budget_name" id="budget_name" value="{{ old('budget_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('budget_reference') ? 'is-invalid' : '' }}" type="text" name="budget_reference" id="budget_reference" value="{{ old('budget_reference', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('close_reason') ? 'is-invalid' : '' }}" type="text" name="close_reason" id="close_reason" value="{{ old('close_reason', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expense_type') ? 'is-invalid' : '' }}" type="text" name="expense_type" id="expense_type" value="{{ old('expense_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_closed') ? 'is-invalid' : '' }}" type="text" name="is_closed" id="is_closed" value="{{ old('is_closed', 'No') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('valid_up_to') ? 'is-invalid' : '' }}" type="text" name="valid_up_to" id="valid_up_to" value="{{ old('valid_up_to') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('assign_user') ? 'is-invalid' : '' }}" name="assign_user_id" id="assign_user_id">
                    @foreach($assign_users as $id => $entry)
                        <option value="{{ $id }}" {{ old('assign_user_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('proposed_by') ? 'is-invalid' : '' }}" name="proposed_by_id" id="proposed_by_id">
                    @foreach($proposed_bies as $id => $entry)
                        <option value="{{ $id }}" {{ old('proposed_by_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
