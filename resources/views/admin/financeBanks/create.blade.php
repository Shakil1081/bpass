...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.financeBank.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.finance-banks.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('updated_by') ? 'is-invalid' : '' }}" type="text" name="updated_by" id="updated_by" value="{{ old('updated_by') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('finance_bank_name') ? 'is-invalid' : '' }}" type="text" name="finance_bank_name" id="finance_bank_name" value="{{ old('finance_bank_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('routing_number') ? 'is-invalid' : '' }}" type="text" name="routing_number" id="routing_number" value="{{ old('routing_number', '') }}" required>
