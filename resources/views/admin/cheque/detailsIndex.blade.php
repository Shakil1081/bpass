...
@section('content')
    @can('organization_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.cheques-details.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.cheque_details.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.cheque_details.title_singular') }} {{ trans('global.list') }}
        </div>
