            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('created_by') ? 'is-invalid' : '' }}" name="created_by" id="created_by" required>
                            @foreach($created_bies as $id => $entry)
                                <option value="{{ $id }}" {{ $document->created_by == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('updated_by') ? 'is-invalid' : '' }}" name="updated_by" id="updated_by">
                            @foreach($updated_bies as $id => $entry)
                                <option value="{{ $id }}" {{ $document->updated_by == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('organization_id') ? 'is-invalid' : '' }}" name="organization_id" id="organization_id">
                            @foreach($organizations as $id => $entry)
                                <option value="{{ $id }}" {{ $document->organization_id == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('created_stamp') ? 'is-invalid' : '' }}" type="text" name="created_stamp" id="created_stamp" value="{{ $document->created_stamp }}" required>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('last_updated_stamp') ? 'is-invalid' : '' }}" type="text" name="last_updated_stamp" id="last_updated_stamp" value="{{ $document->last_updated_stamp }}" required>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('ref_id') ? 'is-invalid' : '' }}" type="text" name="ref_id" id="ref_id" value="{{ $document->ref_id }}" required>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('ref_table') ? 'is-invalid' : '' }}" type="text" name="ref_table" id="ref_table" value="{{ $document->ref_table }}" required>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('file_path') ? 'is-invalid' : '' }}" type="file" name="file_path" id="file_path" >
