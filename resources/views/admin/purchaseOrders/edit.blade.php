            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('updated_by') ? 'is-invalid' : '' }}" name="updated_by_id" id="updated_by_id">
                            @foreach($updated_bies as $id => $entry)
                                <option value="{{ $id }}" {{ (old('updated_by_id') ? old('updated_by_id') : $purchaseOrder->updated_by->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('organization') ? 'is-invalid' : '' }}" name="organization_id" id="organization_id" required>
                            @foreach($organizations as $id => $entry)
                                <option value="{{ $id }}" {{ (old('organization_id') ? old('organization_id') : $purchaseOrder->organization->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('approved_by') ? 'is-invalid' : '' }}" name="approved_by_id" id="approved_by_id">
                            @foreach($approved_bies as $id => $entry)
                                <option value="{{ $id }}" {{ (old('approved_by_id') ? old('approved_by_id') : $purchaseOrder->approved_by->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('requisition') ? 'is-invalid' : '' }}" name="requisition_id" id="requisition_id" required>
                            @foreach($requisitions as $id => $entry)
                                <option value="{{ $id }}" {{ (old('requisition_id') ? old('requisition_id') : $purchaseOrder->requisition->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('actual_payable_amount') ? 'is-invalid' : '' }}" type="number" name="actual_payable_amount" id="actual_payable_amount" value="{{ old('actual_payable_amount', $purchaseOrder->actual_payable_amount) }}" step="0.01" required>
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('vat_amount') ? 'is-invalid' : '' }}" type="number" name="vat_amount" id="vat_amount" value="{{ old('vat_amount', $purchaseOrder->vat_amount) }}" step="0.01">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('amount_in_words') ? 'is-invalid' : '' }}" type="text" name="amount_in_words" id="amount_in_words" value="{{ old('amount_in_words', $purchaseOrder->amount_in_words) }}">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('total_amount') ? 'is-invalid' : '' }}" type="number" name="total_amount" id="total_amount" value="{{ old('total_amount', $purchaseOrder->total_amount) }}" step="0.01" required>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('advance_amount') ? 'is-invalid' : '' }}" type="number" name="advance_amount" id="advance_amount" value="{{ old('advance_amount', $purchaseOrder->advance_amount) }}" step="0.01">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('carr_load_up_amount') ? 'is-invalid' : '' }}" type="number" name="carr_load_up_amount" id="carr_load_up_amount" value="{{ old('carr_load_up_amount', $purchaseOrder->carr_load_up_amount) }}" step="0.01">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('discount_amount') ? 'is-invalid' : '' }}" type="number" name="discount_amount" id="discount_amount" value="{{ old('discount_amount', $purchaseOrder->discount_amount) }}" step="0.01">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('credit_limit') ? 'is-invalid' : '' }}" type="number" name="credit_limit" id="credit_limit" value="{{ old('credit_limit', $purchaseOrder->credit_limit) }}" step="1">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('payment_type') ? 'is-invalid' : '' }}" type="text" name="payment_type" id="payment_type" value="{{ old('payment_type', $purchaseOrder->payment_type) }}">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('supplier') ? 'is-invalid' : '' }}" type="text" name="supplier" id="supplier" value="{{ old('supplier', $purchaseOrder->supplier) }}">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('supplier_name') ? 'is-invalid' : '' }}" type="text" name="supplier_name" id="supplier_name" value="{{ old('supplier_name', $purchaseOrder->supplier_name) }}">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('cell_no') ? 'is-invalid' : '' }}" type="text" name="cell_no" id="cell_no" value="{{ old('cell_no', $purchaseOrder->cell_no) }}">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $purchaseOrder->email) }}">
                        @if($errors->has('email'))
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('supplier_address') ? 'is-invalid' : '' }}" type="text" name="supplier_address" id="supplier_address" value="{{ old('supplier_address', $purchaseOrder->supplier_address) }}">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('delivery_days') ? 'is-invalid' : '' }}" type="text" name="delivery_days" id="delivery_days" value="{{ old('delivery_days', $purchaseOrder->delivery_days) }}">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('delivery_term') ? 'is-invalid' : '' }}" type="text" name="delivery_term" id="delivery_term" value="{{ old('delivery_term', $purchaseOrder->delivery_term) }}">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('is_approve') ? 'is-invalid' : '' }}" type="text" name="is_approve" id="is_approve" value="{{ old('is_approve', $purchaseOrder->is_approve) }}" required>
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('issue_date') ? 'is-invalid' : '' }}" type="text" name="issue_date" id="issue_date" value="{{ old('issue_date', $purchaseOrder->issue_date) }}">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('means_of_transport') ? 'is-invalid' : '' }}" type="text" name="means_of_transport" id="means_of_transport" value="{{ old('means_of_transport', $purchaseOrder->means_of_transport) }}">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('mpr_date') ? 'is-invalid' : '' }}" type="text" name="mpr_date" id="mpr_date" value="{{ old('mpr_date', $purchaseOrder->mpr_date) }}">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('mpr_no') ? 'is-invalid' : '' }}" type="text" name="mpr_no" id="mpr_no" value="{{ old('mpr_no', $purchaseOrder->mpr_no) }}">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('payment_term') ? 'is-invalid' : '' }}" type="text" name="payment_term" id="payment_term" value="{{ old('payment_term', $purchaseOrder->payment_term) }}">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('place_of_delivery') ? 'is-invalid' : '' }}" type="text" name="place_of_delivery" id="place_of_delivery" value="{{ old('place_of_delivery', $purchaseOrder->place_of_delivery) }}">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('place_of_lading') ? 'is-invalid' : '' }}" type="text" name="place_of_lading" id="place_of_lading" value="{{ old('place_of_lading', $purchaseOrder->place_of_lading) }}">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('purchase_order_no') ? 'is-invalid' : '' }}" type="text" name="purchase_order_no" id="purchase_order_no" value="{{ old('purchase_order_no', $purchaseOrder->purchase_order_no) }}">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('reference_date') ? 'is-invalid' : '' }}" type="text" name="reference_date" id="reference_date" value="{{ old('reference_date', $purchaseOrder->reference_date) }}">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('reference_no') ? 'is-invalid' : '' }}" type="text" name="reference_no" id="reference_no" value="{{ old('reference_no', $purchaseOrder->reference_no) }}">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('is_deleted') ? 'is-invalid' : '' }}" type="number" name="is_deleted" id="is_deleted" value="{{ old('is_deleted', $purchaseOrder->is_deleted) }}" step="1">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('deleted') ? 'is-invalid' : '' }}" type="text" name="deleted" id="deleted" value="{{ old('deleted', $purchaseOrder->deleted) }}">
